...
VALUES((TO_CHAR(TO_DATE('2020-01-04','YYYY-MM-DD'),'YYMMDD')||SEQ_MEMBER_ID.NEXTVAL),'김김김'
			,DEFAULT,DEFAULT,'787123-1234567','01011112222','제주시 제주제주',NULL,'2020-01-04',NULL,500000
			,10,'D4','J4');
...
SELECT *
FROM MEMBER_TB JOIN DEPARTMENT_TB USING(DEPT_CODE) JOIN JOB_TB USING(JOB_CODE)
WHERE MEMBER_ID='23072819' AND PASSWORD='1234';