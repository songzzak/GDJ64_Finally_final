...
<style>
  ...
  #writeBoardDiv{margin-left: 20px;}
...
<script>
    $(document).ready(function() {
    	 $(".boardTitle").click(function() {
    		 let boardNo = $(this).closest('tr').find('.boardNo').text().trim();
             location.assign('${path}/board/boardView?no='+boardNo);
         });
    	// 글쓰기 버튼 클릭 이벤트
    ...
    $("#searchBtn").click(function() {
		...
		console.log(type);
		console.log(keyword);
        location.assign('${path}/board/boardList?type='+type+'&keyword='+keyword);
    });
