	...
	<div class="main-section bgc-F8FCFF">		
		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="section-shadow bgc-fff" style="padding: 20px">
			    <input type="text" id="boardTitle" placeholder="제목" required value="${board.boardTitle }"/>
				<div>
...
$(document).ready(function() {
    ...
    $(".remove-file").click(function() {
        ...
        if(confirm('이 파일을 제거하시겠습니까?')) {
            $.ajax({
                url: "${path}/board/removeBoardFile",
                type: "POST",
                data: {fileId: fileId},
    ...
    function updateContent() {
        ...
        if (confirm('공지사항을 수정하시겠습니까?')) {
	        ...
	        formData.append('no', ${board.boardNo});
