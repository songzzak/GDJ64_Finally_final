	...
	<div class="side-menu-container">
		...
		<div>
			...
			<div id="div-approve">
				...
				<button onclick="location.href='${path}/approve/approvePropView.do';">결재대기문서</button>
				<button onclick="">기안문서함</button>
				<button onclick="">참조문서함</button>
				<button onclick="">임시저장함</button>
			</div>
		</div>
		<div>
