...
public class PageFactory {
	...
	public static String getPage(int cPage, int numPerpage, int totalData,String url,String mId) {
		...
		if(pageNo==1) {
			...
			pageBar.append("<li class='page-item visible'>");
...
//		""".formatted(,,,,,,,);
		...
		pageBar.append("location.assign('"+url+"?cPage='+no+'&numPerpage="+numPerpage+"&mId="+mId+"');");
		pageBar.append("}");
		pageBar.append("</script>");
